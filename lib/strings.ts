...
const translations: Record<Locale, Record<string, string>> = {
  ru: {
    ...
    deck_delete_deck_confirm: "Удалить словарь «{name}»? Карточки останутся в других словарях.",
    ...
    deck_search_no_results: "Нет результатов поиска",
  ...
  en: {
    ...
    deck_delete_deck_confirm: "Delete dictionary \"{name}\"? Cards will remain in other dictionaries.",
    deck_cards_aria: "Dictionary cards",
    deck_not_found: "Dictionary not found",
    deck_back_to_list: "← Back to dictionaries",
    deck_back_short: "Back",
    ...
    deck_search_no_results: "No search results",
