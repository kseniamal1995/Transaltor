...
const translations: Record<Locale, Record<string, string>> = {
  ru: {
    ...
    decks_no_custom_decks: "Здесь будут ваши кастомные словари.\nСоздайте их на странице переводчика при добавлении слова.",
    decks_go_to_translator: "Перейти в Переводчик",
  ...
  en: {
    ...
    decks_no_custom_decks: "Your custom dictionaries will appear here.\nCreate them from the Translator page when adding a word.",
    decks_go_to_translator: "Go to Translator",
    decks_page_title: "Study your saved words",
    decks_tab_my: "Your dictionaries",
    decks_tab_collections: "Collections",
    deck_menu_rename: "Rename",
